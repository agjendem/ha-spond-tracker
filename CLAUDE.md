...
pytest                                   # 281 tests as of last count
```
...
| `test-coverage` | [↗](https://developers.home-assistant.io/docs/core/integration-quality-scale/rules/test-coverage/) | ✅ | 281 tests across config_flow, coordinator, sensor, calendar, helpers, i18n |
